                ...
                <div className="page-header-inner tt-wrap">
                    <div className="ph-image">
                        <div className="ph-image-inner">
                            <img src="https://cinedise-video.s3.eu-north-1.amazonaws.com/public/events/header.jpg" alt="Image" />
                        </div>
                    </div>
                            ...
                            <div className="tt-grid ttgr-layout-1-2 ttgr-gap-4">
                                <div className="tt-grid-items-wrap isotope-items-wrap">
                                    {eventProjects.map((project, index) => (
                                        <div key={project.slug} className={`tt-grid-item isotope-item ${index % 2 === 0 ? 'people' : 'creative'}`}>
                                            <div className="ttgr-item-inner">
                                                <div className="portfolio-grid-item">
                                                    <Link href={`/${project.slug}`} className="pgi-image-wrap" data-cursor="View<br>Project">
                ...
                <div className="tt-section padding-bottom-xlg-150">
                    <div className="tt-section-inner tt-wrap">
                        <div className="tt-page-nav tt-pn-scroll">
                            <Link href="/vfx" className="tt-pn-link anim-fadeinup">
                                <div className="tt-pn-title">Next Category</div>
                                <div className="tt-pn-hover-title">VFX</div>
                            </Link>

                            <div className="tt-pn-subtitle anim-fadeinup">Explore More</div>

                            <div className="tt-pn-image">
                                <img src="https://cinedise-video.s3.eu-north-1.amazonaws.com/public/category-thumbnails/category-5.jpg" alt="image" />
                            </div>
                        </div>
                    </div>
                </div>
