...
export default function CommercialsPage() {
    ...
    return (
        <>
            {/* Page Header */}
            <div id="page-header" className="ph-full ph-cap-xxlg ph-image-cropped ph-image-cover-2 ph-content-parallax">
                <div className="page-header-inner tt-wrap">
                    <div className="ph-image">
                        <div className="ph-image-inner">
                            <img src="https://cinedise-video.s3.eu-north-1.amazonaws.com/public/commercials/header.jpg" alt="Image" />
                        </div>
                    </div>
                                ...
                                <div key={project.slug} className="portfolio-list-item">
                                    <div className="pli-inner">
                                        <div className="pli-image-col">
                                            <Link href={`/${project.slug}`} className="pli-image-link" data-cursor="View<br>Project">
                                                <div className="pli-image-holder">
                                                    <figure className="pli-image">
                                                        <img className="anim-image-parallax tt-lazy" src={project.headerImage} data-src={project.headerImage} alt={project.title} />
                                                    </figure>
                                                </div>
                                        ...
                                        <div className="pli-info-col pli-info-outer">
                                            <div className="pli-info">
                                                ...
                                                <h2 className="pli-title"><Link href={`/${project.slug}`}>{project.title}</Link></h2>
                                                <div className="pli-categories-wrap">
                                                    <div className="pli-category">{project.category}</div>
                                                </div>
                                            </div>
                ...
                <div className="tt-section padding-bottom-xlg-150">
                    <div className="tt-section-inner tt-wrap">
                        <div className="tt-page-nav tt-pn-scroll">
                            <Link href="/social-media" className="tt-pn-link anim-fadeinup">
                                <div className="tt-pn-title">Next Category</div>
                                <div className="tt-pn-hover-title">Social Media</div>
                            </Link>

                            <div className="tt-pn-subtitle anim-fadeinup">Explore More</div>

                            <div className="tt-pn-image">
                                <img src="https://cinedise-video.s3.eu-north-1.amazonaws.com/public/category-thumbnails/category-3.jpg" alt="image" />
                            </div>
                        </div>
                    </div>
                </div>
