                    ...
                    <div className="ph-image">
                        <div className="ph-image-inner">
                            <video autoPlay muted loop playsInline className="ph-video">
                                <source src="https://cinedise-video.s3.eu-north-1.amazonaws.com/public/films/background-video_1.mp4" type="video/mp4" />
                            </video>
                        </div>
                    </div>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <div className="pi-list-cont">
                                    <a href="https://www.youtube.com/watch?v=ZXqEM8KaF7M" target="_blank" rel="noopener noreferrer">
                                        Watch the trailer<span className="pi-list-icon"><i className="fas fa-arrow-right"></i></span>
                                    </a>
                                </div>
                            </li>
                        </ul>
                                        ...
                                        {['batch-1.png', 'batch-2.png', 'batch-3.png'].map((img, i) => (
                                            <div key={i} className="tt-grid-item isotope-item">
                                                <div className="ttgr-item-inner">
                                                    <img src={`https://cinedise-video.s3.eu-north-1.amazonaws.com/public/films/${img}`} alt={`Image ${i + 1}`} className="anim-image-parallax" />
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                ...
                <div className="tt-section">
                    <div className="tt-section-inner">
                        <div className="tt-image tti-fixed-height">
                            <figure>
                                <img className="anim-image-parallax tt-lazy" src="https://cinedise-video.s3.eu-north-1.amazonaws.com/public/films/parallax.png" alt="Parallax Image" />
                            </figure>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="tt-row">
                            <div className="tt-col-lg-8">
                                ...
                                <div className="anim-fadeinup text-gray">
                                    <p>The Unequals is an action-packed short film shot on Sony FX30 with cinematic visuals and dynamic compositions. It features high-end VFX crafted by artists over 500+ hours and is graded in Rec. 709 for theatre and Netflix standards. With Dolby Atmos sound, it offers an immersive 360° audio experience for the audience.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="tt-grid ttgr-layout-3 ttgr-not-cropped ttgr-shifted ttgr-gap-4">
                                <div className="tt-grid-items-wrap isotope-items-wrap lightgallery">
                                    {['poster-1.jpg', 'poster-2.jpg', 'poster-3.jpg'].map((img, i) => (
                                        <div key={i} className="tt-grid-item isotope-item">
                                            <div className="ttgr-item-inner">
                                                <a href={`https://cinedise-video.s3.eu-north-1.amazonaws.com/public/films/${img}`} className="tt-gallery-item lg-trigger" data-cursor="View">
                                                    <div className="tt-gallery-item-inner">
                                                        <div className="tt-gallery-image-wrap anim-zoomin">
                                                            <figure className="tt-gallery-image ttgr-height">
                                                                <img src={`https://cinedise-video.s3.eu-north-1.amazonaws.com/public/films/${img}`} alt="Poster" />
                                                            </figure>
                                                        </div>
                                                    </div>
                                                </a>
                ...
                <div className="tt-section padding-bottom-xlg-150">
                    <div className="tt-section-inner tt-wrap">
                        <div className="tt-page-nav tt-pn-scroll">
                            <a href="/commercials" className="tt-pn-link anim-fadeinup">
                                <div className="tt-pn-title">Next Category</div>
                                <div className="tt-pn-hover-title">Commercials</div>
                            </a>
                            <div className="tt-pn-subtitle anim-fadeinup">Explore More</div>
                            <div className="tt-pn-image">
                                <img src="https://cinedise-video.s3.eu-north-1.amazonaws.com/public/category-thumbnails/category-2.jpg" alt="Commercials" />
                            </div>
                        </div>
                    </div>
                </div>
